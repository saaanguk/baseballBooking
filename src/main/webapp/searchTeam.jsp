                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">구단 찾기</h1>
                            <h6 class="text-center">나에게 맞는 구단을 찾으세요.</h6>
	                                   ...
	                                   <% 
										    ...
										    try {
										        ...
										        while (rs.next()) {
										            ...
										            out.println("<article>");
										            out.println("<a href='joinTeam.jsp?team=" + teamName + "'>");
										            out.println("<img alt='' src='File/" + imageFileName + "'>");
										            out.println("<label>" + teamName + "</label>");
