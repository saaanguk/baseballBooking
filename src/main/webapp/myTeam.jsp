									...
									<div class="row">
										...
										<table class="table table-hover">
										    ...
										    try {
										        ...
										        String SQL = "SELECT * FROM member where team = ? order by position2 desc";
										        ...
										        // 가져온 팀 정보를 반복하여 표시
										        while (rs.next()) {
										        	String pst2 = rs.getString("position2");
										        	...
										        	if(position2.equals("감독")){%>
										        			<tr>
															    ...
															    <td><a href="teamOut.jsp?id=<%=rs.getString("id") %>&name=<%= rs.getString("name") %>"><button type="button">방출</button></a>
															</tr>    
