            ...
            <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="container">
                    <form id="Login" action="loginCheck.jsp" method="post">
					  <h2><span class="entypo-login"><i class="fa fa-sign-in"></i></span> Login</h2>
					  <button class="submit"><span class="entypo-lock"></span></button>
					  
				
					  <input type="text" class="user" placeholder="urserID" name='id'/>
					  
					  <input type="password" class="pass"placeholder="password" name='pw'/>
					  <a href="join.jsp"><input type="button" class="entypo-join" value="Join"></a>
					</form>
                </div>
