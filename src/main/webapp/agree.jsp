...
<%
	...
	int result = memberDAO.joinTeam(member.getName(), member.getPh(), member.getTeam());
	int result1 = memberDAO.deleteTeamAgree(member.getName(), member.getTeam());
