							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
									...
									<div class="row">
										...
										<form method="post" action="teamBoardSave.jsp">
											...
											<div class="container" role="main">
												...
												<h2>글쓰기</h2>
													...
													<div class="mb-3">
														...
														<input type="text" class="form-control" name="text" id="text" placeholder="제목을 입력해 주세요">
												...
												<div >
													...
													<button type="button" class="btn btn-sm btn-primary" onclick="location.href='teamBoard.jsp'" id="btnList">목록</button>
