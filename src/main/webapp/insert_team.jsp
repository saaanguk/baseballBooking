                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">구단 창설</h1>
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0" style="margin-left:43%;">
									...
									<form method="post" enctype="multipart/form-data" action="addTeam.jsp" >
									    <input  type="file" name="file" onchange="imageChoose(this)"/><br></br>
									
									    <!--사진설명 + 업로드버튼-->
					
									         <input type="text" placeholder="구단명" name='teamName'/></br></br>
									         <input type="text" placeholder="활동 지역" name="addr"></br></br>
									        <button class="cta blue">구단 창설</button>
									    </form> 
