                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">내 정보</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0" style="margin-left:38%;">
									
									<form method="post" action="pwCheck.jsp" >
									   
									         <input type="password" placeholder="비밀번호를 입력해 주세요." name='pw' style="width:300px"/>
									         
									         <button class="cta blue">확인</button>
									</form> 
