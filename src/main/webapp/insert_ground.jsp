                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            <h1 class="text-white text-center">구장 추가</h1>
                        ...
                        <div class="col-12">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0" style="margin-left:43%;">
									<img id="uploadedImage" src="" name="img">
									<form method="post" enctype="multipart/form-data" action="addGround.jsp" >
									    <input  type="file" name="file" onchange="imageChoose(this)"/><br></br>
							
									    	
									         <input type="text" placeholder="구장명" name='groundName'/></br></br>
									         <input type="text" placeholder="지역" name="groundLocation"></br></br>
									        <button class="cta blue">구장 등록</button>
									    </form> 
