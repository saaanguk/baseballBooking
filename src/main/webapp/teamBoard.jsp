								...
								<div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
									...
									<div class="row">
												...
												<%if(session.getAttribute("team") == null){%>
													<button type="button" class="btn btn-primary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem; background-color: rgb(129, 221, 241); border: none; float: right;" onclick="if(confirm('팀에 가입 되어있지 않습니다.'))location.href='searchTeam.jsp';">글쓰기</button>
												<%}else{%>
													<a href="writeTeamBoard.jsp"><button type="button" class="btn btn-primary" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem; background-color: rgb(129, 221, 241); border: none; float: right;" >글쓰기</button></a>
												<%}%>
										...
										<table class="table table-hover">
											...
											<tbody>
											    ...
											    // 페이지별 게시물 조회 쿼리
											    String selectQuery = "SELECT * FROM team_board WHERE team_name=? and available = 1 ORDER BY reg_date DESC LIMIT ?, ?";
